...
QT_MOC_LITERAL(3, 18, 10), // "closeEvent"
QT_MOC_LITERAL(4, 29, 12), // "QCloseEvent*"
QT_MOC_LITERAL(5, 42, 5) // "event"

    },
    "Results\0finished\0\0closeEvent\0QCloseEvent*\0"
    "event"
};
...
void Results::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Results::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Results::finished)) {
                *result = 0;
                return;
            }
        }
